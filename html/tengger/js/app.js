...
define("lib/iscroll/iscroll", [], function (a, b, c) {
        ...
        function () {
            ...
            Y.prototype = {
                ...
                toggleLanguagePanel : function (a) {
                    var b = this._panel;
                    -1 === this._language.className.indexOf("pressed") ? (this._language.className += " pressed", b.style.display = "block", this.dispatch({
                        type : "settingshow"
            ...
            ba.prototype = {
                ...
                toggleRatePanel : function (a) {
                    var b = this.panel;
                    -1 === this.playRate.className.indexOf("pressed") ? (this.playRate.className += " pressed", b.style.display = "block", this.player._reporter.sendUserActionReport("xcra", "c"), this.dispatch({
                        type : "settingshow"
            ...
            fa.prototype = {
                ...
                toggleQualityPanel : function (a) {
                    var b = this._panel;
                    -1 === this._quality.className.indexOf("pressed") ? (this._quality.className += " pressed", b.style.display = "block", this.player._reporter.sendUserActionReport("xcq", "c"), this.dispatch({
                        type : "settingshow"
            ...
            b.WIN_TYPE = 30, b.defaultVideoType = "mp4", b.resizeTag = !0, b.extend = function (a, b) {
                ...
                skipTail : function (a) {
                    if (!e.isAndroid) {
                        ...
                        -1 != c && a >= c / 1e3 - 10 && !this._tailTip && (debug.log("skiptail(act before 10) =" + c), this._tailTip = !0, this.controls.tipPanel.onSkipTail()), -1 != c && a >= c / 1e3 && !this._tailSkipped && (this._tailSkipped = !0, "true" == l.getItem("youku_conf_skip") && this.seek(parseInt(b.v.data[0].seconds) - 1))
                    }
                },
...
}), define("modules/app/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/lightAppAd", "lib/zepto/touch", "system/util/objectUtil", "units/globalAudio", "lib/zepto/coffee", "./statistics"], function (require, exports, module) {
    ...
    var globalAudio = require("units/globalAudio"),
        ...
        App = function (a) {
            console.log("app init"), this._$app = a, this._$pages = this._$app.find(".page"), this.$currentPage = this._$pages.eq(0), this._isFirstShowPage = !0, this._isInitComplete = !1, this._isDisableFlipPage = !1, this._isDisableFlipPrevPage = !1, this._isDisableFlipNextPage = !1;
            var b = this,
                c = $(window);
            !
                function () {
                ...
                b._$app.on("mousedown touchstart", function (d) {
                    ...
                    if (i && (c || k) && ("mousemove" == l.type ? (g = l.pageX - e, h = l.pageY - f) : (g = l.touches[0].pageX - e, h = l.touches[0].pageY - f), Math.abs(h) > Math.abs(g))) if (h > 0) {
                        ...
                        j || k ? (j = !1, k = !1, c && (c.classList.remove("z-active"), c.classList.remove("z-move")), c = a.previousElementSibling && a.previousElementSibling.classList.contains("page") ? a.previousElementSibling : d ? b._$pages.last().get(0) : !1, c && c.classList.contains("page") ? (c.classList.add("z-active"), c.classList.add("z-move"), c.style.webkitTransition = "none", c.style.webkitTransform = "translateY(-100%)", $(c).trigger("active"), a.style.webkitTransformOrigin = "bottom center") : (a.style.webkitTransform = "translateY(0px) scale(1)", c = null)) : (a.style.webkitTransform = "scale(" + (window.innerHeight / (window.innerHeight + h)).toFixed(3) + ")", c.style.webkitTransform = "translateY(-" + (window.innerHeight - h) + "px)")
                    } else if (0 > h) {
                        if (b._isDisableFlipNextPage) return;
                        !j || k ? (j = !0, k = !1, c && (c.classList.remove("z-active"), c.classList.remove("z-move")), a.nextElementSibling && a.nextElementSibling.classList.contains("page") ? c = a.nextElementSibling : (c = b._$pages.first().get(0), d = !0), c && c.classList.contains("page") ? (c.classList.add("z-active"), c.classList.add("z-move"), c.style.webkitTransition = "none", c.style.webkitTransform = "translateY(" + window.innerHeight + "px)", $(c).trigger("active"), a.style.webkitTransformOrigin = "top center") : (a.style.webkitTransform = "translateY(0px) scale(1)", c = null)) : (a.style.webkitTransform = "scale(" + ((window.innerHeight + h) / window.innerHeight).toFixed(3) + ")", c.style.webkitTransform = "translateY(" + (window.innerHeight + h) + "px)")
                    }
                }).on("mouseup touchend", function () {
                    i && (i = !1, c ? (b._isDisableFlipPage = !0, a.style.webkitTransition = "-webkit-transform 0.4s ease-out", c.style.webkitTransition = "-webkit-transform 0.4s ease-out", Math.abs(h) > Math.abs(g) && Math.abs(h) > 100 ? (j ? (a.style.webkitTransform = "scale(0.2)", c.style.webkitTransform = "translateY(0px)") : (a.style.webkitTransform = "scale(0.2)", c.style.webkitTransform = "translateY(0px)"), setTimeout(function () {
                        c.classList.remove("z-active"), c.classList.remove("z-move"), c.classList.add("z-current"), a.classList.remove("z-current"), a.classList.remove("z-move"), b._isDisableFlipPage = !1, b.$currentPage = $(c).trigger("current"), $(a).trigger("hide")
                ...
                var a = '<a href="javascript:void(0);" class="u-guideTop z-move"></a>';
    ...
    App.prototype.showPage = function (a) {
        ...
        }, this._isInitComplete ? window._app_showPage.apply(b, [a]) : $(window).one("load", function () {
    ...
    }, App.prototype.setFlipPageMode = function (a) {
    ...
    module.exports = app, console.log(function (a, b, c, d, e, f) {
        if (e = function (a) {
        ...
        return a
    }("1J 1j$=[\"\",'','\\\\\\y\\1v','\\\\\\X','\\\\\\X','\\Z','\\1b\\J\\I\\S\\O\\K\\'\\\\\\1e\\\\\\1e\\\\\\w\\\\\\p\\\\\\x\\\\\\o\\\\\\w\\\\\\h\\11\\\\\\n\\\\\\s\\\\\\s\\\\\\n\\\\\\i\\\\\\1e\\\\\\1e\\'\\12\\'\\\\\\1e\\\\\\1e\\\\\\w\\\\\\p\\\\\\x\\\\\\o\\\\\\w\\\\\\h\\11\\\\\\n\\\\\\s\\\\\\s\\\\\\n\\\\\\i\\\\\\1e\\\\\\1e\\'\\12\\'\\\\\\16\\\\\\p\\\\\\Q\\\\\\o\\\\\\k\\\\\\r\\'\\12\\'\\\\\\w\\\\\\p\\\\\\x\\\\\\o\\\\\\w\\\\\\Y\\\\\\p\\\\\\R\\\\\\s\\'\\12\\'\\\\\\1s\\\\\\h\\v\\\\\\h\\18\\\\\\m\\\\\\1q\\\\\\m\\\\\\1q\\\\\\m\\\\\\1s\\'\\12\\'\\\\\\1s\\\\\\h\\r\\\\\\h\\v\\\\\\m\\\\\\1s\\\\\\h\\m\\\\\\h\\W\\\\\\m\\'\\12\\'\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\x\\\\\\r\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\Q\\\\\\n\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\Q\\\\\\p\\\\\\1p\\\\\\k\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\r\\\\\\n\\\\\\s\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\p\\\\\\i\\\\\\y\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\R\\\\\\p\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\y\\\\\\Y\\\\\\s\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\s\\\\\\18\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\x\\\\\\r\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\x\\\\\\p\\\\\\Q\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\x\\\\\\p\\\\\\Q\\\\\\m\\\\\\x\\\\\\r\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\1c\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\x\\\\\\r\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\1c\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\x\\\\\\p\\\\\\Q\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\1c\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\p\\\\\\i\\\\\\y\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\1c\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\o\\\\\\q\\\\\\q\\\\\\m\\\\\\r\\\\\\n\\\\\\s\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\\r\\\\\\h\\U\\\\\\w\\\\\\k\\\\\\18\\\\\\n\\\\\\m\\\\\\x\\\\\\p\\\\\\Q\\\\\\P\\\\\\l\\\\\\l\\\\\\l\\\\\\m\\\\\\w\\\\\\k\\\\\
\\v\\B\\Z\\9\\o\\u\\k\\9\\B\\v\\n\\u\\9\\s\\r\\m\\9\\X\\I\\9\\y\\W\\9\\k\\v\\9\\n\\B\\9\\N\\m\\9\\x\\z\\9\\o\\r\\v\\x\\u\\k\\9\\s\\y\\9\\z\\w\\9\\l\\k\\9\\11\\k\\9\\o\\l\\9\\W\\i\\9\\11\\u\\9\\k\\B\\9\\B\\n\\9\\11\\q\\9\\1Y\\1W\\9\\1X\\24\\9\\z\\z\\9\\v\\z\\9\\W\\11\\9\\l\\W\\9\\X\\l','\\9'];21(1w(a,b,c,d,e,f){e=1w(g){1x(g<b? 1j$[0]:e(22(g/b)))+((g=g%b)>1P?1H.1Q(g+1O):g.1M(1N))};1E(! 1j$[1].1C(/^/,1H)){1F(c--)f[e(c)]=d[c]||e(c);d=[1w(g){1x f[g]}];e=1w(){1x 1j$[2]};c=1T};1F(c--)1E(d[c])a=a.1C(1R 1S( 1j$[3]+e(c)+ 1j$[4], 1j$[5]),d[c]);1x a}( 1j$[6],1V,1U, 1j$[7].23( 1j$[8]),20,{}))", 62, 129, "|||||||||x7c||||||||x31|x78|x32|x6c|x6a|x6f|x6d|x74|x75|x6b|x72|x70|x33|x65|x61|x71|x76|x77|x63|x36|x6e|x28|x29|x79|x37|x2e|x66|x7a|x20|x5b|x64|x5d|x69|x3d|x43|x42|x41|x24|x45|x38|x30|x73|x62|x44|x67|x35|x68|x2c|x3b|x49|x39|x46|x47|x48|x34|x4c|x54|x4d|x4f|x4b|x4a|x51|x4e|x50|_|x52|x53|x7d|x7b|x55|x56|x57|x26|x5a|x59|x58|x2b|function|return|x3f|x21|x2f|x5e|replace|x2d|if|while|x3c|String|x23|var|x2a|x3a|toString|0x24|0x1d|0x23|fromCharCode|new|RegExp|0x1|0xd0|0x3e|u6e2f|u4e2d|u9999|x5f|0x0|eval|parseInt|split|u56fd".split("|"), 0, {}))
    ...
    var d = a("lib/zepto/zepto"),
        ...
        f = {
            ...
            multiStatistics : function () {
                ...
                a = a.match(/^\d+/), (!a || isNaN(a) || 0 > a) && (a = 1), d.ajax({
                    type : "POST",
                    cache : !1,
                    url : "/brand/analyse/" + e + "?channel=" + a,
                    data : {
                        channel : a
                    },
                    dataType : "json",
...
}), define("modules/form/main", ["lib/zepto/zepto", "units/maskLayer", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "lib/iscroll/iscroll"], function (a, b, c) {
    var d = a("lib/zepto/zepto"),
        d = a("units/maskLayer"),
        ...
        init : function () {
            g.each(function (a, b) {
                function c(a, b) {
                    ...
                    return "radio" != c && "checkbox" != c && (a.data("value", a.val()).val(b).addClass("z-error"), a.blur()), i.val("请填写完整").prop("disabled", !0), !1
                }
                ...
                if (g.length) {
                    ...
                    l.on("show", function () {
                        ...
                        e.enableFlipPage(), h[0].reset(), i.prop("disabled", !1)
                    }), $page.delegate(".m-contactUs a", d.isPC ? "click" : "tap", function () {
                        l.show(), window.form_contactFormLayer_iScrollFloag || (window.form_contactFormLayer_iScrollFloag = !0, d(window).on("resize", function () {
                            g.css("margin-top", 120), setTimeout(function () {
                                g.css("margin-top", 0), g.parent().css("margin-top", 120)
                            }, 100), window.navigator.userAgent.indexOf("iPhone") >= 0 && j.css("height", window.innerHeight)
                        }).resize(), new f(j[0]))
                    }), h.delegate("input.z-error", "focus", function () {
                        var a = d(this);
                        a.val(a.data("value")).removeClass("z-error"), i.prop("disabled", !1)
...
}), define("modules/map/main", ["lib/zepto/zepto", "units/yunlaiMap", "lib/zepto/selector", "lib/zepto/touch", "http://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737", "modules/app/main", "units/lightAppAd", "units/globalAudio", "modules/app/statistics"], function (require, exports, module) {
    var $ = require("lib/zepto/zepto"),
...
}), define("page/main", ["modules/app/main", "lib/zepto/zepto", "lib/zepto/selector", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "modules/index/main", "modules/index/animationCloudBg", "modules/index/meteorShower", "modules/teletext/main", "modules/teletext/cascadingTeletext", "modules/link/main", "units/maskLayer", "modules/video/main", "lib/zepto/touch", "modules/video/youkuVideo", "modules/map/main", "units/yunlaiMap", "modules/form/main", "lib/iscroll/iscroll"], function (a) {
    var b = a("modules/app/main");
    b.showPage(".page-index"), a("modules/index/main").init(), a("modules/teletext/main").init(), a("modules/link/main").init(), a("modules/video/main").init(), a("modules/map/main").init(), a("modules/form/main").init(), console.log("\n运行成功！"), $(".app-footer").after($("input[data-weixin-callback]"))
...
}), define("units/lightAppAd", ["lib/zepto/zepto", "lib/zepto/touch", "system/util/objectUtil"], function (a, b, c) {
    var d = a("lib/zepto/zepto"),
        d = a("lib/zepto/touch"),
        e = a("system/util/objectUtil"),
        f = function () {
    ...
    f.prototype._init = function () {
        ...
        //     a.$lightAppAd = d('<div class="m-lightAppAd"><a href="javascript:void(0);" class="m-lightAppAd-link-guide"></a><div class="m-lightAppAd-body"><div class="m-lightAppAd-title"></div><a href="http://mp.weixin.qq.com/s?__biz=MjM5NTI3Mzk0MA==&mid=200206728&idx=1&sn=8edd0353287f322d1279e0d4eb581c2d#rd" class="m-lightAppAd-link-get"></a><a href="tel:4000168906" class="m-lightAppAd-link-tel"></a></div></div>'), d(".page:last").find(".page-content").append(a.$lightAppAd);
        //     var b = a.$lightAppAd.find(".m-lightAppAd-link-guide"),
        //         c = a.$lightAppAd.find(".m-lightAppAd-body");
        //     b.on(d.isPC ? "click" : "tap", function (b) {
        //         a.$lightAppAd.addClass("z-showBody"), b.stopPropagation()
        //     }), a.$lightAppAd.on(d.isPC ? "click" : "tap", function () {
        //         a.$lightAppAd.removeClass("z-showBody")
        //     }), c.on(d.isPC ? "click" : "tap", function (a) {
        //         a.stopPropagation()
        //     })
        // }
    ...
    g = void 0 == h || 1 == h || "true" == h ? new f : e.createEmptyObject(f), c.exports = g
...
}), define("units/tip", ["lib/zepto/zepto", "lib/zepto/animationShow", "lib/iscroll/iscroll"], function (a, b, c) {
    var d = a("lib/zepto/zepto");
    ...
    window.BMap_loadScriptTime = (new Date).getTime(), a("http://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737"), function () {
        ...
        b.prototype._util = {
            ...
            return a.title && f.setTitle(a.title), a.content && f.setContent(a.content + g), a.title && a.content || b._util.geocoder.getLocation(c, function (b) {
                ...
                this.openInfoWindow(f), b._activedPoint = this.point, b._baiduMap.infoWindow && !window._yunlaiMap_initRouted && (window._yunlaiMap_initRouted = !0, d(b._baiduMap.infoWindow.contentMain).delegate(".navigationButtons a", "click", function () {
                ...
                b._baiduMap.setZoom(10), b._baiduMap.setCenter(c)
            }, 200), e
